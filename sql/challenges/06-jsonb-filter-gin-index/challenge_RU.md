...
Бизнес-задача: Каталожная отчетность считает premium fragile продукты, сохраненные внутри JSONB attributes.

Ожидаемый результат: Одна строка с `premium_fragile_products`.
