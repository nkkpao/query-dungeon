...
- Never expose suggested solutions by default.
...
- Suggested solutions are for comparison only.
...
- Default commands must run participant-selected SQL, not suggested solution SQL.
- Validation must check correctness without executing suggested solutions.
